...
EN_TRANSLATIONS = {
    ...
    "关闭": "Close",
    "显示/隐藏搜索": "Show/Hide Search",
    "退出": "Quit",
    "快捷键": "Hotkey",
    "已关闭": "Off",
    "未启用": "Unavailable",
    "全局快捷键未启用": "Global hotkey is not enabled",
    "启用全局快捷键（⌃F）": "Enable global hotkey (⌃F)",
    "全局快捷键设置将在下次启动后生效": "Global hotkey setting will take effect after restart",
